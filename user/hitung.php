...
{ 
  $date=date('d-F-Y');
  $thn=substr($date,7,11);
$total=$harta/40;
$simpan=mysqli_query($koneksi,"INSERT INTO data_satu_tahun (id_user,tahun,zakat) values('$iduser','$thn','$total')") or die(mysqli_error());
if($simpan)
{
...
echo "
            ...
            <p>Harta ". $nama ." = Rp.". $harta ." <br/>
               ...
               Jadi  $nama WAJIB membayar zakat mal sebanyak 2,5% x Rp.$harta = Rp.".$total;
